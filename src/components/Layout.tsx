...
import { Bell, LogOut, User, LayoutDashboard, Settings, Users } from 'lucide-react';
            ...
            <div className="flex items-center gap-4">
              {currentUser ? (
                <>
                  ...
                  {userProfile?.role === 'admin' && (
                    <Link to="/students" className="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium flex items-center gap-2">
